...
object DateTimeUtil {
    ...
    const val STANDARD_TIME_ZONE = "UTC"
...
fun String.convertDateFromStandardTimeZone(
    ...
    try {
        ...
        inputFormat.timeZone = TimeZone.getTimeZone(DateTimeUtil.STANDARD_TIME_ZONE)
...
fun String.convertDateToStandardTimeZone(
    ...
    try {
        ...
        val outputFormat = SimpleDateFormat(outputPattern ?: inputPattern, Locale.getDefault())
        outputFormat.timeZone = TimeZone.getTimeZone(DateTimeUtil.STANDARD_TIME_ZONE)
